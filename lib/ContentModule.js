...
class ContentModule extends AbstractApiModule {
  ...
  async updateEnabledPlugins ({ _courseId, _type }, options = {}, parentOptions, parentMongoOptions) {
    ...
    // ignoreRequired: docs were valid before the plugin was enabled; some plugins (e.g. adapt-contrib-glossary)
    // declare a top-level required property with no default, which Ajv can't materialise from missing parents
